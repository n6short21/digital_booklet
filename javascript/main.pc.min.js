...
this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){var c=this,d,e,f,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return bookConfig.ToolBarVisible?h.yield(new Promise(function(l){return requestAnimationFrame(l)}),2):h.return();a=void 0==a?c.parent.width():parseInt(a);b=void 0==b?c.parent.height():parseInt(b);d=a/4;e=a/4;
