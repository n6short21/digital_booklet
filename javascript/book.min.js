...
function initIssuuBook(b,c){"issuu"!=bookConfig.FlipStyle||bookType!=BookType.normal_book&&bookType!=BookType.single_book||($.extend(b,{thickness:bookConfig.FlipDirection?!1:!0,staticad:getStaticAdVisible(),bookmarktab:global.bmtConfig?!0:!1}),$.extend(c,{thickness:bookConfig.showThicknessOnMobile&&!bookConfig.FlipDirection?!0:!1,bookshadow:!0,grayshadow:!1,miniFullscreen:shouldShowMiniFullscreen(),bookpagenumber:bookConfig.updatePageNumberForFlip?!0:!1,staticad:!1,zoommap:bookConfig.ZoomMapVisible?
...
getConfigValue("power_info","");tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info&&(tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info));tmpBookConfig.isShowBottomFullscreenPrompts=getConfigValue("isShowBottomFullscreenPrompts",!0);tmpBookConfig.isMobileFirstLastShortcutVisible=getConfigValue("isMobileFirstLastShortcutVisible",!0);tmpBookConfig.isMobilePageBackButtonVisible=getConfigValue("isMobilePageBackButtonVisible",!1);tmpBookConfig.enableDomainAccess=getConfigValue("enableDomainAccess",
!0);tmpBookConfig.domainAccess=getConfigValue("domainAccess","").toLowerCase();tmpBookConfig.isSearchFormNailUpEnabled=getConfigValue("isSearchFormNailUpEnabled","Chinese"==UserGroups?!1:!0);tmpBookConfig.showWatermark=getConfigValue("showWatermark",!1);tmpBookConfig.printWatermark=getConfigValue("printWatermark",!0);tmpBookConfig.watermarkRotation=getConfigValue("watermarkRotation",0);tmpBookConfig.watermarkSpacing=getConfigValue("watermarkSpacing",20);tmpBookConfig.watermarkOpacity=getConfigValue("watermarkOpacity",
.4);tmpBookConfig.watermarkPosition=getConfigValue("watermarkPosition","Center").toLowerCase();tmpBookConfig.watermarkWidth=getConfigValue("watermarkWidth",100);tmpBookConfig.watermarkHeight=getConfigValue("watermarkHeight",0);tmpBookConfig.watermarkEdgeMargin=getConfigValue("watermarkEdgeMargin",12);tmpBookConfig.flipShortcutButtonColor=getConfigValue("flipShortcutButtonColor","");tmpBookConfig.flipShortcutButtonHoverColor=getConfigValue("flipShortcutButtonHoverColor","");tmpBookConfig.flipShortcutButtonBackgroundColor=
getConfigValue("flipShortcutButtonBackgroundColor","");tmpBookConfig.flipShortcutButtonHoverBackgroundColor=getConfigValue("flipShortcutButtonHoverBackgroundColor","");tmpBookConfig.printOptions=getConfigValue("printOptions","all,current,range").toLowerCase();tmpBookConfig.isBookDomainAccessEnabled=getConfigValue("isBookDomainAccessEnabled",!0);tmpBookConfig.isZoomControlBarVisible=getConfigValue("isZoomControlBarVisible",!0);tmpBookConfig.autoFlipPageOnTimelineEnd=getConfigValue("autoFlipPageOnTimelineEnd",
...
var VERSION_NAME="7.0.0",BUILD_DATE="2025121501",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
