...
var b=_get(window,"website_domian_wc","https://fliphtml5.com"),c=removeUrlParts(window.location.href);bookConfig.socialShareLink&&(c=bookConfig.socialShareLink);var d=getMetaTagValueByName("description"),e=getMetaTagValueByName("keywords");b+="/chatbot/chatbot.php";c=Metacharacter(c);e=Metacharacter(e);d=Metacharacter(d);var f=this.isRtl()?"1":"0",g,h,l=(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' src='"+
(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+l)+"' ></iframe>");this.frame.on("load",function(){a.onLoadIframe()});this.container.append(this.chatbotBox);this.container.append(this.chatBotBtn);this.parent.append(this.container);this.chatbotBox.css({"box-sizing":"border-box","z-index":9999,position:"absolute",right:"120px",bottom:"50px",width:"421px",height:"740px",opacity:0,visibility:"hidden","border-radius":"12px"});this.chatbotResize.append(this.frame);this.chatbotResize.append(this.resizeLeft);
...
a=void 0===a.greeting?"":a.greeting;var c=this.chatBotBtnTips.find(".chatbot-btn-beckon");c&&c.empty().text(a);this.getPopupTipsVisible()&&(a=this.chatBotBtn.find("img")[0],a.complete?this.showChatBotBtnTips():a.addEventListener("load",function(){b.showChatBotBtnTips()}))},handleResize:function(){function a(k,n){function p(u){this.isResizing=!0;g=u.center.x;h=u.center.y;l=c.width();m=c.height();switch(n){case "right":c.css({right:"initial",left:u.center.x-l+"px"});break;case "left":c.css({right:"initial",
left:u.center.x+"px"});break;case "top":c.css({bottom:"initial",top:u.center.y+"px"});break;case "bottom":c.css({bottom:"initial",top:u.center.y-m+"px"})}$(k).css({cursor:"move"});d.css({display:"block"});b.frame.css({"box-shadow":"none",border:"none"})}function q(u){if(this.isResizing){var x=Math.min(u.center.x-g,e),v=Math.min(u.center.y-h,f);if(!(u.center.x>e||u.center.y>f||0>u.center.x||0>u.center.y))switch(n){case "right":c.css({width:l+x+"px"});break;case "left":c.css({left:u.center.x+"px",width:l-
x+"px"});break;case "top":c.css({top:u.center.y+"px",height:m-v+"px"});break;case "bottom":c.css({height:m+v+"px"})}}}function r(){this.isResizing=!1;"left"!=n&&"right"!=n||$(k).css({cursor:"ew-resize"});"top"!=n&&"bottom"!=n||$(k).css({cursor:"ns-resize"});d.css({display:"none"});b.frame.css({"box-shadow":"0 0 20px 0 rgba(0, 0, 0, 0.1)",border:"1px solid rgba(0,0,0,0.1)"})}var t=new Hammer(k);t.add(new Hammer.Pan({threshold:0,pointers:0}));t.on("panstart panmove panend",function(u){u.preventDefault();
switch(u.type){case "panstart":p(u);break;case "panmove":q(u);break;case "panend":r(u)}})}document.querySelectorAll(".chatbot-resize-item").forEach(function(k){var n=k.classList[1].split("-")[2];a(k,n)});var b=this,c=this.chatbotBox,d=this.resizeMask,e=this.parent.width(),f=this.parent.height(),g=0,h=0,l=0,m=0},initResizeCss:function(){this.resizeMask.css({display:"none",position:"absolute",left:0,top:0,right:0,bottom:0,"z-index":1E3});this.resizeLeft.css({position:"absolute",left:0,top:0,bottom:0,
...
k.chatBotBtnTips[0]&&(n=k.chatBotBtnTips[0].getBoundingClientRect(),k.chatBotBtnTips.css({left:r-n.width-8+"px",right:"initial",bottom:window.innerHeight-p-m.height+"px"}))}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer"})}var e=a.$el,f=a.parent,g=a.callback;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,l=0,m,k=this;a.on("panstart panmove panend",function(n){n.preventDefault();switch(n.type){case "panstart":b(n);break;case "panmove":c(n);break;case "panend":d(n)}});
...
c=removeUrlParts(window.location.href);bookConfig.socialShareLink&&(c=bookConfig.socialShareLink);var d=getMetaTagValueByName("description"),e=getMetaTagValueByName("keywords");b+="/chatbot/chatbot.php";c=Metacharacter(c);e=Metacharacter(e);d=Metacharacter(d);var f=this.isRtl()?"1":"0",g,h,l=(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' border='0' width='100%' height='100%' src='"+
(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+l)+"' ></iframe>");this.frame.on("load",function(){a.onLoadIframe()});this.stage.insertBefore(this.parent);this.stage.css({opacity:1,"z-index":"1001",transition:"all 0.3s ease",position:"absolute",left:this.width+"px",top:0,width:"100%",height:"100%",overflow:"hidden",visibility:"hidden"});this.frame.css({border:"none",padding:0,margin:0,overflow:"hidden",display:"none"});this.stage.append(this.frame)},initEvent:function(){var a=this;window.addEventListener("message",
...
this.setSrc(this.goButton,"goPage");this.inputButton=$("<div class='inputButton' style='width:190px;'>\n        <label>\n          <input aria-labelledby='currentPageIndex' id='currentPageIndexTextField' enterkeyhint=\"go\" type='text'/>\n        </label>\n      </div>");bookConfig.enablePageBack&&this.inputButton.css({width:"100px"});bookConfig.enablePageBack&&this.contentBox.append(this.backwardButton);bookConfig.isMobileFirstLastShortcutVisible&&this.contentBox.append(this.firstButton);this.contentBox.append(this.prevButton);
this.contentBox.append(this.inputButton);this.contentBox.append(this.nextButton);bookConfig.isMobileFirstLastShortcutVisible&&this.contentBox.append(this.lastButton);bookConfig.enablePageBack&&this.contentBox.append(this.forwardButton);tmpContainer.append(this.pagePrevButton);tmpContainer.append(this.pageNextButton);if(bookConfig.FlipDirection){this.pagePrevButton.css({position:"absolute",top:"40px",left:"50%","z-index":"110",transform:"translate(-50%,0)"});this.pageNextButton.css({position:"absolute",
bottom:"40px",left:"50%","z-index":"110",transform:"translate(-50%,0)"});var a={width:"56px",height:"36px"};switch(bookConfig.phoneFlipShortcutButtonSize){case "small":a={width:"56px",height:"36px"};break;case "normal":a={width:"66px",height:"56px"};break;case "large":a={width:"76px",height:"76px"}}}else switch(this.pagePrevButton.css({position:"absolute",top:"50%",left:"0","z-index":"11",transform:"translate(0%,-50%)"}),this.pageNextButton.css({position:"absolute",top:"50%",right:"0","z-index":"11",
transform:"translate(0%,-50%)"}),a={width:"36px",height:"56px"},bookConfig.phoneFlipShortcutButtonSize){case "small":a={width:"36px",height:"56px"};break;case "normal":a={width:"56px",height:"76px"};break;case "large":a={width:"76px",height:"96px"}}this.pagePrevButton.css(a);this.pageNextButton.css(a);this.inputButton.find("input").css({padding:"0px","text-align":"center","border-width":"0px",background:"rgba(255,255,255,0.7)",width:"100%",height:"30px","border-radius":"15px",position:"absolute",
color:bookConfig.pageNumColor,left:0,top:0});(isPhone()||isPad())&&this.inputButton.find("input").css({})},initSlider:function(){this.onStepLength=(windowWidth-80)/bookConfig.totalPageCount;this.slider=$("<div style='position:absolute;cursor:pointer;left:40px;top:65px;width:"+(windowWidth-80)+"px;height:4px;background:"+this.iconColor.rgba(.3)+";border-radius: 2px;'></div>");this.sliderEnter=$("<div style='position:absolute;"+this.direction+":0;top:0;width:0px;height:4px;background:"+this.iconColor.toString()+
";border-radius: 2px;'></div>");this.pointer=$("<div style='cursor:pointer;position:absolute;"+this.direction+":12px;top:-10px;width:20px;height:20px;border-radius: 50%;padding:2px;'><div style='pointer-events: none;border:3px solid "+this.iconColor.toString()+";width:14px;height:14px;border-radius: 50%;background: "+this.mainColor.toString()+";'></div></div>");this.slider.append(this.sliderEnter).append(this.pointer);this.menu.append(this.slider);this.initSliderEvent()},initSliderEvent:function(){this.slider.onTap(function(a){if(a.srcEvent){var b=
rightToLeft?windowWidth-a.srcEvent.pageX:a.srcEvent.pageX;bookConfig.upsideOnMobile()&&(b=rightToLeft?windowWidth-a.srcEvent.pageY:a.srcEvent.pageY)}else b=rightToLeft?windowWidth-a.pageX:a.pageX,bookConfig.upsideOnMobile()&&(b=rightToLeft?windowWidth-a.pageY:a.pageY);this.endLeft=b-51;this.endLeft=-11>this.endLeft?-11:this.endLeft>windowWidth-91?windowWidth-91:this.endLeft;gotoPageFun(this.getSlideIndex(this.endLeft),!1,"phone goto slider")}.bind(this));this.pointer.bind(_event._down,function(a){this.isTouchDown=
!0}.bind(this));this.slider.bind(_event._down,function(a){this.startPos=this.getPosition(a);40>=this.startPos.x&&(this.startPos.x=40);this.startPos.x>=windowWidth-40&&(this.startPos.x=windowWidth-40)}.bind(this));this.menu.bind(_event._move,function(a){if(this.isTouchDown){this.endPos=this.getPosition(a);40>=this.endPos.x&&(this.endPos.x=40);this.endPos.x>=windowWidth-40&&(this.endPos.x=windowWidth-40);var b=this.endPos.x-this.startPos.x;this.endLeft=rightToLeft?this.pointer.right()-b:this.pointer.left()+
b;this.endLeft=-11>this.endLeft?-11:this.endLeft>windowWidth-91?windowWidth-91:this.endLeft;1.01<Math.abs((this.endPos.x-this.startPos.x)/(this.endPos.y-this.startPos.y))&&a.preventDefault();a=this.getSlideIndex(this.endLeft);$("#currentPageIndexTextField").val(this.getPageNumberInfo(a));a={};this.pointer.css((a[this.direction]=this.endLeft+"px",a));this.sliderEnter.css({width:(rightToLeft?windowWidth-this.endPos.x-38:this.endPos.x-38)+"px"});this.startPos=this.endPos}}.bind(this));this.menu.bind(_event._end,
function(a){this.isTouchDown&&(this.isTouchDown=!1,this.endLeft&&this.endPos&&(gotoPageFun(this.getSlideIndex(this.endLeft),!1,"phone goto slider"),a={},this.pointer.css((a[this.direction]=this.endLeft+"px",a)),this.sliderEnter.css({width:this.endPos.x-38+"px"})))}.bind(this))},onResize:function(){this.onStepLength=(windowWidth-80)/bookConfig.totalPageCount;this.slider.css({width:windowWidth-80+"px"});this.refreshSlider();this.refreshInputSize()},getSlideIndex:function(a){a=Math.ceil((a+11)/this.onStepLength);
a>=bookConfig.totalPageCount&&(a=bookConfig.totalPageCount);1>=a&&(a=1);return a},refreshSlider:function(){if(this.isBetweenPagesPos()){var a={};this.pointer.animate((a[this.direction]=this.endLeft+"px",a));this.sliderEnter.animate({width:this.endLeft+4+"px"})}else if(a=-11+this.onStepLength*BookInfo.getCurrentPageIndex(),1==BookInfo.getCurrentPageIndex())a={},this.pointer.animate((a[this.direction]="-11px",a)),this.sliderEnter.animate({width:"0px"});else{BookInfo.getCurrentPageIndex()==bookConfig.totalPageCount&&
(a=windowWidth-91);var b={};this.pointer.animate((b[this.direction]=a+"px",b));this.sliderEnter.animate({width:a+4+"px"})}},refreshInputSize:function(){var a=60>windowWidth-160+3?60:windowWidth-160+3;bookConfig.enablePageBack?this.inputButton.css({"max-width":(60>a-80?60:a-80)+"px"}):this.inputButton.css({"max-width":a+"px"})},isBetweenPagesPos:function(){if(!this.endLeft)return!1;var a=BookInfo.getBook().getCurrentPages();if(1==a.length){if(this.endLeft<=-11+a[0]*this.onStepLength&&this.endLeft>=
-11+(a[0]-1)*this.onStepLength)return!0}else if(this.endLeft>=-11+(a[0]-1)*this.onStepLength&&this.endLeft<=-11+a[1]*this.onStepLength)return!0;return!1},getPageNumberInfo:function(a){return rightToLeft?bookConfig.totalPageCount+"/"+a:a+"/"+bookConfig.totalPageCount},getPosition:function(a){a=a.originalEvent&&a.originalEvent.changedTouches?a.originalEvent.changedTouches:a.changedTouches?a.changedTouches:[a];var b=(a[0].pageX||a[0].clientX)+(document.documentElement.scrollLeft||document.body.scrollLeft);
a=(a[0].pageY||a[0].clientY)+(document.documentElement.scrollTop||document.body.scrollTop);return bookConfig.upsideOnMobile()?{x:a,y:b}:{x:b,y:a}},resetPosition:function(){this.contentBox.html("");this.initContentBox();this.initEvent()},setSrc:function(a,b,c){var d=a.find("img");a=a.find(".svg-box");c&&""!=c?(d.attr("src",c),a.css({display:"none"})):phoneSvgIcons&&phoneSvgIcons[b]&&(a.html(phoneSvgIcons[b]),d.css({display:"none"}));this.colorChanged=!1},changeCaptionColor:function(a){if(this.fontColor||
a)a||(a=this.fontColor.toString()),this.$caption&&this.$caption.css("color",a)},showPageFlipButton:function(){bookConfig.showInstructionOnStart&&1==BookInfo.getCurrentPageIndex()||(this.pageFlipVisible=!0,this.pagePrevButton.fadeIn(200),this.pageNextButton.fadeIn(200))},hidePageFlipButton:function(){this.pageFlipVisible=!1;this.pagePrevButton.fadeOut(200);this.pageNextButton.fadeOut(200)},show:function(){this.refreshSlider();toolBar.extendedBar&&toolBar.extendedBar.visible&&toolBar.extendedBar.hide();
var a=toolBar.getBottomHeight(!0);this.menu.animate({bottom:a},300);this.visible=!0},hide:function(){this.menu.animate({bottom:-140},300);this.visible=!1},showOrHide:function(){!0===this.visible?this.hide():this.show()},initEvent:function(){this.firstButton.onTap(function(){BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"first",getLanguage("btnFirstPage","First")]);rightToLeft?lastPageFun("phone goto button"):firstPageFun("phone goto button");return!1});this.prevButton.onTap(function(){rightToLeft?
nextPageFun("phone goto button"):previousPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"prev",getLanguage("btnPrePage","Previous")]);return!1});this.nextButton.onTap(function(){rightToLeft?previousPageFun("phone goto button"):nextPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"next",getLanguage("btnNextPage","Next")]);return!1});this.lastButton.onTap(function(){BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),
"last",getLanguage("btnLastPage","Last")]);rightToLeft?firstPageFun("phone goto button"):lastPageFun("phone goto button");return!1});this.pagePrevButton.onTap(function(){rightToLeft?nextPageFun("phone goto button"):previousPageFun("phone goto button");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"prev",getLanguage("btnPrePage","Previous")]);return!1});this.pageNextButton.onTap(function(){rightToLeft?previousPageFun("phone goto button"):nextPageFun("phone goto button");BookEvent.trigger("clickButton",
[BookInfo.getCurrentPageIndex(),"next",getLanguage("btnNextPage","Next")]);return!1});this.goButton.onTap(function(){var a=parseInt($("#currentPageIndexTextField").val().replace(/\D/g,""));gotoPageFun(Math.min(Math.max(a,1),bookConfig.totalPageCount),!1,"input");BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"goButton","goButton"]);return!1}.bind(this));this.backwardButton.onTap(function(){rightToLeft?flipHistory.forward():flipHistory.backward();BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),
"backward",getLanguage("btnPageBack","Backward")]);return!1});this.forwardButton.onTap(function(){rightToLeft?flipHistory.backward():flipHistory.forward();BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"forward",getLanguage("btnPageForward","Forward")]);return!1})},destroy:function(){this.menu.remove();global.phoneGotoPagePanel=null},showFirstOrLast:function(){if(bookConfig.phoneFlipShortcutButton&&(!(global.handSwipeHelp&&global.handSwipeHelp.visible||!global.handSwipeHelp&&bookConfig.showInstructionOnStart)||
1!=BookInfo.getCurrentPageIndex())){if(bookConfig.RightToLeft){if(1==BookInfo.getCurrentPageIndex()){this.pagePrevButton.fadeIn(200);this.pageNextButton.hide();return}if(BookInfo.getCurrentPageIndex()==bookConfig.totalPageCount){this.pagePrevButton.hide();this.pageNextButton.fadeIn(200);return}}else{if(1==BookInfo.getCurrentPageIndex()){this.pagePrevButton.hide();this.pageNextButton.fadeIn(200);return}if(BookInfo.getCurrentPageIndex()==bookConfig.totalPageCount){this.pagePrevButton.fadeIn(200);this.pageNextButton.hide();
return}}this.pagePrevButton.fadeIn(200);this.pageNextButton.fadeIn(200)}}});$(document).ready(function(){isWeiXinAndIos()&&(document.body.addEventListener("focusin",function(){setTimeout(function(){tmpContainer.css({top:"auto"})},200)}),document.body.addEventListener("focusout",function(){setTimeout(function(){window.scrollTo({top:0,left:0,behavior:"smooth"});tmpContainer.css({top:"0"})},200)}))});
...
function initComponents(){"article4"==global.templeteName&&(bookConfig.flipshortcutbutton=!1,bookConfig.BackgroundSoundButtonVisible=!1,bookConfig.ThumbnailsButtonVisible=!1,bookConfig.SearchButtonVisible=!1,bookConfig.isChatBotButtonVisible=!1,bookConfig.isAccessibilityButtonVisible=!1,bookConfig.QRCode=!1,bookConfig.appLargeLogoIcon=!1,bookConfig.EnableReportButton=!1,bookConfig.addCurrentPage=!1,bookConfig.BackgroundSoundURL="");var a=["lively","minimalist"];!bookConfig.flipshortcutbutton&&!bookConfig.isFirstLastShortcutVisible||
global.flipShotButton||"catalog"==bookConfig.FlipStyle.toLowerCase()||a.includes(global.templeteName)||(global.flipShotButton=new FlipShotButton(tmpContainer));if(isPhone()||isPad()){if("article4"==global.templeteName){global.phoneArticleReader||(global.phoneArticleReader=new PhoneArticleReader4({parent:tmpContainer,formType:"reader",rightToLeft:rightToLeft,isPhone:!0}));global.phoneArticleList||(global.phoneArticleList=new PhoneArticleList({parent:tmpContainer,formType:"articlelist",rightToLeft:rightToLeft,
isPhone:!0}));return}bookConfig.BackgroundSoundButtonVisible&&!global.settingBody&&(global.settingBody=new PhoneSettingForm({parent:tmpContainer,formType:"setting",rightToLeft:rightToLeft}));bookConfig.ThumbnailsButtonVisible&&(global.thumbnail||(global.thumbnail="Classical"===_get(htmlConfig,"phoneTemplate.name")?new PhoneThumbnailForm2({parent:tmpContainer,formType:"thumbnail",rightToLeft:rightToLeft}):new PhoneThumbnailForm({parent:tmpContainer,formType:"thumbnail",rightToLeft:rightToLeft})),"thumbnails"==
bookConfig.mobileLeftRightPnlShowOption&&(global.thumbnail.show(),global.thumbnail.stage&&global.thumbnail.stage.show()));global.phoneGotoPagePanel||(global.phoneGotoPagePanel=new phoneGotoPage(tmpContainer));bookConfig.searchbarAlwaysShowOnMobile&&!global.phoneSearchBar&&bookConfig.SearchButtonVisible&&(global.phoneSearchBar=new PhoneSearchBar(tmpContainer));bookConfig.SearchButtonVisible&&!global.frmSearch&&(global.frmSearch=new PhoneSearchForm({parent:tmpContainer,formType:"search",rightToLeft:rightToLeft}));
bookConfig.phoneFlipShortcutButton&&!global.phoneGotoPagePanel&&global.phoneGotoPagePanel.showPageFlipButton();0<=global.templeteName.indexOf("article")&&("article"!=global.templeteName||global.phoneArticleReader||(global.phoneArticleReader=new PhoneArticleReader({parent:tmpContainer,formType:"reader",rightToLeft:rightToLeft,isPhone:!0})),"article3"!=global.templeteName||global.phoneArticleReader||(global.phoneArticleReader=new PhoneArticleReader3({parent:tmpContainer,formType:"reader",rightToLeft:rightToLeft,
isPhone:!0})),"article2"!=global.templeteName||global.phoneArticleReader||(global.phoneArticleReader=new PhoneArticleReader2({parent:tmpContainer,formType:"reader",rightToLeft:rightToLeft,isPhone:!0})),global.phoneArticlePages||(global.phoneArticlePages=new PhoneArticlePages({parent:tmpContainer,formType:"article",rightToLeft:rightToLeft,isPhone:!0})),global.phoneArticleList||(global.phoneArticleList=new PhoneArticleList({parent:tmpContainer,formType:"articlelist",rightToLeft:rightToLeft,isPhone:!0})));
bookConfig.isChatBotButtonVisible&&!global.chatbotPanel&&(global.chatbotPanel=new PhoneChatbot({parent:tmpContainer,formType:"chatbot",rightToLeft:rightToLeft,isPhone:!0}),a=getHashParams("chatbotVisible"),b=GetQueryString("chatbot"),(a&&"true"==a||b&&"1"==b)&&global.chatbotPanel.show())}else{bookConfig.BackgroundSoundButtonVisible&&("brief"!=global.templeteName||global.settingBody?bookConfig.BackgroundSoundURL&&!global.settingBody&&(global.settingBody=new PcSoundSettingForm({parent:tmpContainer,
